...
namespace Sarhne.DAL.Migrations
{
    ...
    [Migration("20260610162728_update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sarhne.DAL.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sarhne.DAL.Entities.UserSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Sarhne.DAL.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sarhne.DAL.Entities.Message", b =>
                {
                    b.HasOne("Sarhne.DAL.Entities.User", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sarhne.DAL.Entities.User", "Sender")
            ...
            modelBuilder.Entity("Sarhne.DAL.Entities.UserSetting", b =>
                {
                    b.HasOne("Sarhne.DAL.Entities.User", "User")
                        .WithOne("UserSetting")
                        .HasForeignKey("Sarhne.DAL.Entities.UserSetting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
